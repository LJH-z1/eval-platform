...
const routes = [
  ...
  { path: '/register', name: 'register', component: () => import('@/views/auth/Register.vue'),    meta: { public: true, title: '注册' } },
  {
    ...
    children: [
      ...
      { path: 'score',         name: 'score',         component: () => import('@/views/score/ScoreMain.vue'), meta: { title: '多维评分' } },
      { path: 'score/:id',     name: 'score-form',    component: () => import('@/views/score/ScoreForm.vue'), meta: { title: '评分' } },
